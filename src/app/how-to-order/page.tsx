...
import { ShoppingBag, Sparkles, CreditCard, Package, ArrowRight, Clock } from 'lucide-react';
...
const shopSteps = [
  ...
  },
  {
    ...
    description: "Your handcrafted set is carefully packaged and shipped to you within 5–7 working days. You'll receive tracking information once dispatched.",
  },
];
...
const customSteps = [
  ...
  },
  {
    ...
    description: 'Custom sets are shipped within 7–10 working days after payment confirmation. Worth every day of the wait!',
  },
];
