...
const Categories = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Collections | Nail Shingaar by Reet</title>
        <meta
          name="description"
          content="Browse our press-on nail collections. French tips, glitter, floral, minimalist, ombre, and artistic designs."
        />
      </Helmet>
      <Layout>
          ...
          <div className="bg-gradient-card py-16">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="mt-2 text-muted-foreground">
                Find your perfect style from our curated categories
              </p>
            </div>
          </div>
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {categories.map((category, index) => (
                  ...
                  >
                    <img
                      src={category.image_url || 'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=600'}
                      alt={category.name}
                    ...
                    <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
                      <div>
                        ...
                        {category.description && (
                          <p className="text-sm text-background/80 mt-1 max-w-[200px]">
                            {category.description}
                          </p>
                        )}
                      </div>
