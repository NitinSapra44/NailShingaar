...
const ProductDetail = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{product.name} | Nail Shingaar by Reet</title>
        <meta name="description" content={product.description ?? `Shop ${product.name} — handcrafted custom press-on nails by Nail Shingaar.`} />
      </Helmet>
      <Layout>
        <div className="container mx-auto px-4 py-12 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <Button
                size="lg"
                className="w-full rounded-full shadow-soft hover:shadow-glow transition-shadow text-base"
