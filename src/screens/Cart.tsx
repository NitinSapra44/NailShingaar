...
const Cart = () => {
  ...
  if (items.length === 0) {
    return (
      <>
        <Helmet>
          <title>Your Cart | Nail Shingaar by Reet</title>
        </Helmet>
        <Layout>
          <div className="container mx-auto px-4 py-24 text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Looks like you haven't added any items yet. Explore our collections!
            </p>
  ...
  const checkoutTo = user ? '/checkout' : '/auth?redirect=/checkout';
            ...
            <div className="lg:col-span-2 space-y-4">
              {items.map((item) => {
                ...
                return (
                  <div
                    key={`${productId}-${size}`}
                    className="flex gap-4 p-4 rounded-2xl bg-card shadow-soft border border-border"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <Link
                        ...
                        className="font-medium hover:text-primary transition-colors leading-snug"
                      >
                        {product.name}
                      </Link>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 p-6 rounded-2xl bg-card shadow-card border border-border">
                ...
                <Button
                  ...
                  size="lg"
                >
                  <Link to={checkoutTo}>Proceed to Checkout</Link>
                </Button>
